...
// https://gitee.com/zhou-jian-guo/highlight_line_number
    ...
    if (lines.length > 0 || options.singleLine) {
        ...
        for (let i = 0, l = lines.length; i < l; i++) {
            ...
            html += format(
                ...
                }catch (error) {return inputHtml;}
                //}catch (error) {console.error("line ",i,": error:",error); return inputHtml;}
        }
...
function hljs_ln() {
    const addlineNumbersBlock = function  (element, options) {
        lineNumbersBlock(element, options);
    }
    const addLineNumbersBlockForText = function  (inputHtml, options) {
        return addLineNumbersBlockFor(inputHtml, options);
    }
    return {
        addlineNumbersBlock,
        addLineNumbersBlockForText,
    };
}

"object" == typeof exports && "undefined" != typeof module && (module.exports = hljs_ln);
